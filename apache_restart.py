...
#
# Restarts apache on the given server list. Sometimes
# will need a simple graceful reread, other times will
# need a service disrupting restart. Jenkins will specifiy
# which is needed.
#
# 2 Sept 2015 - dyanetta
...
print(BLUE + "Restarting apache on all servers..." + NC) 
