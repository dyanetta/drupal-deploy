...
#
# Uses drush commands to update the database.
# Only has to be done on 1 server, since the DB 
# is shared among all deployments.
#
...
print(BLUE + "drush updb being run on some server, somewhere..." + NC) 
